...
env_alloc(struct Env **newenv_store, envid_t parent_id)
{
	...
	e->env_runs = 0;
	e->env_prioritry = 3;
	e->env_count_of_executions = 0;
	e->env_count_interruptions = 0;
...
env_destroy(struct Env *e)
{
	...
	e->end = mc146818_read(0);

	// cprintf("Finalizando proceso en %d segundos \n", e->end - e->start);
